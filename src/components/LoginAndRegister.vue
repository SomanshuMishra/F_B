    ...
    a.style.display = "flex";
        ...
        async loginUser(){
            ...
            .then((userCredential) => {
                ...
                // const subColRef = getDocs(collection(fsdb, "mealPlans", "8PXKw6RPwgd5TSO0CAj2H4Eec7I2", "userMealPlan"));
                // console.log('subColRef',subColRef)
                // if (subColRef.exists()) {
                //     console.log('hi')
                // }
                // getDocs(collection(fsdb, "mealPlans",'8PXKw6RPwgd5TSO0CAj2H4Eec7I2','userMealPlan')).then(docSnap1 => {
                //     if (docSnap1.exists()) {
                //         console.log("Document usermeal data:", docSnap1.data());
